...
namespace NSCC_WebAppProg_SeatYourself.Controllers
{
    public class VenuesController : Controller
    {
        ...
        public VenuesController(NSCC_WebAppProg_SeatYourselfContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VenueId,Name,Description,ImagePath,Location,Capacity")] Venue venue)
        {
